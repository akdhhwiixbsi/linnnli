/*************************************
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/.+ url script-response-body https://raw.githubusercontent.com/akdhhwiixbsi/linnnli/main/Pre.js
^https?:\/\/api\.revenuecat\.com\/v1\/.+ url script-request-header https://raw.githubusercontent.com/akdhhwiixbsi/linnnli/main/Pre.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';
  const UAMappings = {
    'AmiiBoss':{ name: 'pro', id: 'com.previsshot.previsshot.continuous_subscribe_12month_vip'},
  };
  const data = {
