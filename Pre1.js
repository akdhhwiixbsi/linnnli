...
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/akdhhwiixbsi/linnnli/main/Pre1.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'pro', id: 'com.previsshot.previsshot.continuous_subscribe_12month_vip'}};
  const data = {
