...
var body = $response.body;
    ...
    body = body.replace(/"end_ts":".*?"/g,'\"end_ts":"2058-08-08 12:00:00"');
    
    body = body.replace(/"is_buy":0/g,'\"is_buy":1');

  body = body.replace(/"allow_play_title":"可试看"/g,'\"allow_play_title":"');
  
  body = body.replace(/"expire_ts":".*?"/g,'\"expire_ts":"2058-01-08"');
